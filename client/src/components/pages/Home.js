        ...
        <Row>
            ...
            <Accordion defaultActiveKey='0'>
              ...
              <Card>
                ...
                <Accordion.Collapse eventKey='1'>
                  <Card.Body>
                    <p className='lead'>
                      Dengan melaporkan diri pengatasan masalah akan menjadi
                      lebih mudah :
                    </p>
                    <ol>
                      <li>
                        Pembuatan Dokumen yang hilang akan menjadi lebih cepat
                        dan mudah pengurusannya
                      </li>
                      <li>
          ...
          <Col>
            ...
            <p>
              ...
              kontak dan Pihak Universitas menanyakan kehadiran dan dengannya
              LaDi semua permasalahan akan menjadi lebih mudah dan akan
              mendapatkan penyelesaian yang lebih cepat.{" "}
            </p>
            <p>
              <b>Ayo Lapor Diri!</b>
            </p>
