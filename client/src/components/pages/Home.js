...
const Home = () => {
  ...
  const guestHome = (
    <Row>
      ...
      <Col>
        ...
        <p>
          yang dimana dapat menyebabkan keluarga di Indonesia kehilangan kontak
          dan Pihak Universitas menanyakan kehadiran dan dengannya LaDi semua
          permasalahan akan menjadi lebih mudah dan akan mendapatkan
  ...
  return (
    <Fragment>
      ...
      <Container>{loading || !isAuthenticated ? notice : null}</Container>
